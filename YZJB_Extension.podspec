...
Pod::Spec.new do |s|
  ...
  s.name         = "YZJB_Extension"
  s.version      = "1"
  s.summary      = "YZJB_Extension."
  ...
  s.source       = { :git => "https://github.com/YZJMediator/YZJB.git", :tag => "Extension-"+s.version.to_s }
  ...
  s.source_files  = "YZJB/YZJB_Category/**/*.{h,m}"
